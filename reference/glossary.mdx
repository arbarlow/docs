...
**ATL**
See Fatigue (Acute Training Load) in Stride.
...
See "Load" - Stride's term for long-term training stress (42-day average).

**Crank**
The arm that connects your pedal to the bike's bottom bracket.

**CTL**
Common abbreviation for Chronic Training Load. In Stride, we call this "Load."
...
Power divided by heart rate. Higher values indicate better aerobic fitness.

## F

**Fatigue (Acute Training Load)**
Stride's measure of recent training stress - your 7-day average Training Score.

**Form**
In Stride: the difference between Load and Fatigue. Indicates readiness to perform.
...
**Intensity**
How hard you're working, measured by power, heart rate, or perceived effort.

**Intensity Factor (IF)**
Normalized Power divided by FTP. Shows how hard a ride was relative to your threshold.
...
**Normalized Power (NP)**
Weighted average power that accounts for variability. Better represents physiological cost than average power.
...
See "Form" - the difference between fitness (Load) and Fatigue.

**TSS**
Training Stress Score - common metric. In Stride, we call this "Training Score."
...
Normalized Power divided by Average Power. Shows how steady your effort was.
...
**Zone**
Range of intensity for training. Typically 7 zones from recovery to neuromuscular power.

**Zone 2**
Endurance zone. Foundation of aerobic fitness. Should be majority of training.
...
- **TS**: Training Score (Stride's TSS)
