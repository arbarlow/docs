...
#### 🆕 New Features
- **FIT File Downloads**: Download original FIT files from activities
- **Zwift Workout Export**: Export structured workouts to Zwift format

#### 🔧 Improvements
- Better power data validation with improved bad power flagging
- Enhanced compliance margin for activities under 1 hour

#### 🐛 Bug Fixes
- Fixed curve display issues
- Fixed duplicate sync issues with Wahoo devices
- Resolved plan minutes filter calculations

### Week of June 17-23

#### 🆕 New Features
- **AI Training Tools**: New AI-powered workout improvement and optimization features
- **Workout Calendar View**: Enhanced calendar view for better workout visualization
- **Plans Search**: Added search functionality for training plans
- **New Workouts Page**: Redesigned workouts page with improved navigation

#### 🔧 Improvements
- Markdown support in calendar previews
- Small UI tweaks and improvements for plans

#### 🐛 Bug Fixes
- Fixed issues when adding workouts to older activities

### Week of June 10-16

#### 🆕 New Features
- **Official Plans & Workouts**: Added official badge system and official plan support
- **Plan Optimization**: New plan optimization features with discipline-specific adjustments
- **AI-Powered Improvements**: "Improve with AI" functionality for workouts

#### 🔧 Improvements
- Plan page styling ready for enhanced content
- Activity page touch-ups and UI improvements

### Week of June 1-9

#### 🆕 New Features
- **Plan Duplication**: Ability to duplicate existing training plans
- **Running Pace Input**: New running pace input field for better running workouts

#### 🔧 Improvements
- Running-specific tweaks and enhancements
- Workout description improvements
- Plan view redesign for better user experience
